...
$subject = 'Aanvraag om wachtwoord te wijzigen';

$message= '<h3>Aanvraag om een nieuwe wachtwoord</h3>';

$message .= '  Klik op de link om je wachtwoord te wijzigen. <br>';
...
if ($existMail) {
    ...
    $folder = '/app/nl/restore/action/bba08facec60bb175aec7f4c24cb1a89';
