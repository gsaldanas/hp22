...
const message = {
    pw_length: 'Votre mot de passe doit comporter au moins 8 caractères.',
    no_match: 'Le nouveau mot de passe et le mot de passe de confirmation ne correspondent pas !!',
    strong: 'La chaîne doit contenir au moins les éléments suivants : 1 lettre minuscule, 1 lettre majuscule et 1 chiffre.'
};
...
ui.zie_pwd.addEventListener('click', function () {
    ...
    if (ui.input_fields[0].type == 'text') {
        ...
        this.innerHTML = 'Afficher le mot de passe';
    } else {
        ui.input_fields[0].type = 'text';
        ui.input_fields[1].type = 'text';
        this.innerHTML = 'masquer le mot de passe';
    }
